<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.name" style="width: 200px;" class="filter-item" placeholder="组件名称" @keyup.enter.native="handleFilter" />

      <el-button v-btnHas="'menu:search'" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">
        搜索
      </el-button>

      <el-button v-btnHas="'menu:add'" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate">
        新增
      </el-button>
    </div>
    <!--表格渲染-->
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="220">
        <template slot-scope="scope">
          <el-button v-btnHas="'menu:modify'" type="primary" size="mini" @click="handleUpdate(scope.row)">
            修改
          </el-button>
          <el-button v-btnHas="'menu:delete'" type="danger" size="mini" @click="deleteMenu(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="新增/修改" :visible.sync="dialogFormVisible" width="580px">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-else v-btnHas="'menu:update'" type="primary" @click="updateData">保存</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
<script>
import { queryMenu, updateMenu, deleteMenu, createMenu, getChildrenMenu } from '@/api/admin/menu'
